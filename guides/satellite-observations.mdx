...
description: "Query wave data from satellite altimeter missions — CFOSAT, Jason-3, Sentinel-3, and more — alongside in-situ buoys."
---

## What are satellite observations?

Beyond fixed, in-situ buoys, the API also surfaces **wave measurements from satellite altimeter missions**. As a satellite passes overhead, its altimeter measures significant wave height (and related parameters) along its orbital track. These open-ocean measurements complement the coastal buoy network, extending coverage to areas no physical buoy reaches.
